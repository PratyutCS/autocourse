...
import { IoSearch, IoFilter, IoClose, IoCheckmark } from "react-icons/io5";
        ...
        <div className="flex-1 p-6 overflow-auto">
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="bg-white rounded-lg  p-6 border border-gray-200 transform  ">
              ...
              {/* Modified Box component to use filtered files */}
              <Box files={filteredFiles} userData={userData} />
            </div>
          </div>
        </div>
      </div>
